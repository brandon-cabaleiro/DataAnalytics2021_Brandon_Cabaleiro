...
# 6000 Level
#
# This R code is for lab1_rpart4
#************************************************
...
post(fitK, file = "lab1_rpart4_kyphosistree.ps", title = "Classification Tree for Kyphosis") # might need to convert to PDF (distill)
...
post(pfitK, file = "lab1_rpart4_ptree.ps", title = "Pruned Classification Tree for Kyphosis")
